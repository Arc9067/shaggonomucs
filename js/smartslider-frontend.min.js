(function (t) {
  ...
  var s = t.document,
          ...
          for (var r in n)
            null !== n[r] &&
              ...
              (n[r].constructor !== Object && !Array.isArray(n[r]))
                ...
                : (Array.isArray(n[r])
                    ? (i[r] = [])
                    : ("object" != typeof i[r] || Array.isArray(i[r])) &&
                      (i[r] = {}),
                  (i[r] = m(i[r], n[r]))));
      }
      return i;
    ...
    W = function (t, e, i) {
      return (i = d({ bubbles: !0, cancelable: !0 }, i)), z(t, new Event(e, i));
    },
    Y = function (t, e) {
      return z(t, new Event(e, { bubbles: !1, cancelable: !1 }));
    },
    Z = function (t, e, i) {
      return z(
        t,
        new CustomEvent(e, { bubbles: !1, cancelable: !1, detail: i })
      );
    },
    V = function (t, e, i, s) {
    ...
    U = function (t, e, i, s) {
      return (
        ...
        t.removeEventListener.bind(t, e, i, s)
      );
    },
    j = function (t, e, i, s) {
    ...
    G = function (t, e, i) {
      t.addEventListener(e, i, { once: !0 });
    },
    X = function (t, e, i) {
      t.ssEvent &&
        t.ssEvent[e] &&
        t.ssEvent[e].forEach(function (t) {
          t(i);
        });
    },
    H = function (t, e, i) {
      t.ssEvent || (t.ssEvent = {}),
        t.ssEvent[e] || (t.ssEvent[e] = []),
        t.ssEvent[e].push(i);
    },
    q = function (t, e, i) {
    ...
    Q = function (t, e) {
      if (this.ssEvent && this.ssEvent[t])
        for (var i = this.ssEvent[t], s = i.length - 1; s >= 0; s--)
          i[s] === e && i.splice(s, 1);
    },
    J = function () {
      return h.scrollTop;
      ...
      if (Math.abs(t.scrollTop - e) < 1) s && s();
        ...
        var n = t.scrollTop,
          ...
          a = function (e) {
            ...
            l < 0.5 ? (l *= 2 * l) : (l = (4 - 2 * l) * l - 1),
              (t.scrollTop = n + l * o),
              l < 1 ? requestAnimationFrame(a) : s && s();
          };
        a(r);
      }
    },
  ...
  function lt(t) {
    ...
    if (e && e.sheet) {
      var i,
        n = e.sheet;
      for (i = n.cssRules.length - 1; i >= 0; i--)
        n.cssRules[i].selectorText &&
          n.cssRules[i].selectorText.includes("div#n2-ss-") &&
          n.deleteRule(i);
    }
  }
  nt(function () {
      ...
      return (
        ...
        (t.prototype.onSlideDeviceChanged = function (t) {
          ...
          for (var e = 0; e < this.slider.visibleRealSlides.length; e++)
            this.slider.visibleRealSlides[e].background &&
              this.slider.visibleRealSlides[e].background.onSlideDeviceChanged(
                t
              );
        }),
        ...
        (t.prototype.preloadSlidesLazyNeighbor = function (t) {
          ...
          if (this.lazyLoadNeighbor)
            for (
              var i = 0, s = t[0].getPrevious(), n = t[t.length - 1].getNext();
              i < this.lazyLoadNeighbor;

            )
              s && (e.push(s.preLoad()), (s = s.getPrevious())),
                n && (e.push(n.preLoad()), (n = n.getNext())),
                i++;
    ...
    c.d("ScrollTracker", function () {
      ...
      return (
        (t.prototype.add = function (t, e, s, n) {
          var o = { el: t, mode: e, onVisible: s, onHide: n, state: "unknown" };
          this.items.push(o),
            this._onScroll(o, Math.max(h.clientHeight, i.innerHeight)),
        ...
        (t.prototype.onScroll = function (t) {
          for (
            var e = Math.max(h.clientHeight, i.innerHeight), s = 0;
            s < this.items.length;
            s++
          )
            this._onScroll(this.items[s], e);
        }),
      ...
      (t.prototype.makeReady = function (t, e) {
        ...
        (t.prototype.off = function (t, e) {
          if (this.eventListeners[t] !== o)
            for (var i = this.eventListeners[t].length - 1; i >= 0; i--)
              this.eventListeners[t][i] === e &&
                this.eventListeners[t].splice(i, 1);
        }),
        ...
        (t.prototype.trigger = function (t, e, i) {
          ...
          for (var r = s.length - 1, a = 0; a < s.length; a++)
            s[a] === o && (r = a);
          (e = r === s.length - 1 ? s[0] : s[r + 1]),
            (n.ssLastEvent = e),
            Y(n, "ss" + e);
        }),
        ...
        (t.prototype.applyActionWithClick = function (t) {
          this.isClickAllowed(t) &&
            (c._shouldPreventClick ||
              (t.preventDefault(), this.applyAction.apply(this, arguments)));
        }),
        ...
        (t.prototype.openUrl = function (t, e) {
          if (this.isClickAllowed(t)) {
            ...
            if (
              (e === o && (e = A(t.currentTarget, "target")), "_blank" === e)
            ) {
              var n = i.open();
        ...
        (t.prototype.openUrlKeyDown = function (t, e) {
          ("Enter" !== t.code && "Space" !== t.code) ||
            !t.target.matches(":not(input,select,textarea)") ||
            this.openUrl(t, e);
        });
      var e = {
        focusOffsetTop: 0,
        ...
        element: function (t) {
          "string" == typeof t && (t = s.querySelector(t)),
            e.to(ht(t) - e.focusOffsetTop);
        },
      };
      return (
        (t.prototype.scroll = function (t, s) {
          if (this.isClickAllowed(t)) {
            t.preventDefault();
            var n = this.findSliderByElement(t.target);
            n &&
              ((e.focusOffsetTop = n.responsive.focusOffsetTop),
              t.currentTarget.blur()),
              e[s].apply(i, Array.prototype.slice.call(arguments, 2));
          }
        }),
    ...
    c.d("SmartSliderAbstract", function () {
      function t(e, s) {
        if (
          ((this.editor = null),
          (this.elementID = e),
          i[e] && i[e] instanceof t)
        )
          if (i[e].__sliderElement && !n.contains(i[e].__sliderElement));
          else {
            if (i[e].sliderElement === o)
              return void console.error(
                "Slider [#" + e + "] inited multiple times"
              );
            if (n.contains(i[e].sliderElement))
              return void console.error(
                "Slider [#" + e + "] embedded multiple times"
              );
          }
        (this.stages = new c.Stages()),
          ...
          (this.isAdmin = !!s.admin),
          c.SmartSliderPlugins.addSlider(this),
          (this.id = parseInt(e.replace("n2-ss-", ""))),
          (i[e] = this),
          s.isDelayed !== o && s.isDelayed
            ? nt(
                function () {
      ...
      function f(t, e) {
        if (i.IntersectionObserver)
          new IntersectionObserver(
            function (t, i) {
              for (var s = 0; s < t.length; s++)
                t[s].isIntersecting && (e(), i.disconnect());
            }.bind(this),
            { rootMargin: "200px 0px 200px 0px" }
          ).observe(t);
        else if ((u.push({ element: t, callback: e }), 1 === u.length)) {
          var s = [],
            n = function () {
          ...
          s.push(U(i, "resize", n, { capture: !0 })),
            s.push(U(i, "scroll", n, { capture: !0, passive: !0 })),
            c.SmartSliderApi.on("SliderResize", n),
            n();
        }
      }
      return (
        (t.prototype.onSliderExists = function (t, e, s) {
          if (
            ((this.__sliderElement = s),
            (this.v = s.closest(".n2-section-smartslider")),
            ...
            var o = A(s, "loadingType"),
              ...
              l = function () {
                n.appendChild(a),
                  L(this.v, "height"),
                  this.waitForDimension(a, e),
                  Z(i, "n2Rocket", { sliderElement: a });
              }.bind(this);
            "afterOnLoad" === o
              ? c.r("windowLoad", f.bind(this, this.v, l))
              : "afterDelay" === o
              ? r(l, A(s, "loadingDelay"))
              : l();
        ...
        (t.prototype.initUI = function () {
          ...
          if (
            ...
            new c.UniversalEnter(
              this.sliderElement,
              function (t) {
                t.target.closest(".n2-full-screen-widget") ||
                  (a(e),
            ...
            this.parameters.blockrightclick &&
              j(this.sliderElement, "contextmenu", function (t) {
                t.preventDefault();
              }),
                  ...
                  .forEach(function (t) {
                    j(t, s, function (t) {
                      ...
                      j(t, "mousedown", function (t) {
                        (2 !== t.which && 4 !== t.which) ||
                          (t.preventDefault(), n2ss.openUrl(t, "_blank"));
                      }),
        ...
        (t.prototype.initSlides = function () {
          var t,
            e = this.sliderElement.querySelectorAll(".n2-ss-slide");
          for (t = 0; t < e.length; t++)
            this.slides.push(this.createSlide(e[t], t));
        ...
        (t.prototype.p = function () {
          for (
            ...
            this.staticSlides.push(new c.FrontendSliderStaticSlide(this, t[e]));
        }),
        ...
        (t.prototype.finalizeStarterSlide = function () {
          ...
          if (this.isAdmin) this.finalizeStarterSlideComplete(t);
            ...
            this.overrideStarterSlideIndex(e),
              j(
                this.sliderElement,
        ...
        (t.prototype.shuffleSlides = function (t) {
          ...
          for (var e = t[0].element.parentNode, i = 0; i < t.length; i++)
            e.appendChild(t[i].element), t[i].setIndex(i);
        }),
        ...
        (t.prototype.focus = function (t) {
          ...
          if ((this.responsive.parameters.focusUser && !t && (e = !0), e)) {
            ...
            if (
              ("top" === c
                ? (p = s - n + a.top)
                : "bottom" === c && (p = s + o + a.bottom - r),
              (p = Math.round(p)) !== s)
            )
              return this._scrollTo(p, Math.abs(s - p));
          }
          return !0;
        }),
        ...
        (t.prototype.next = function (t, e) {
          ...
          return (
            !(!i || !this.getUINextSlide(this.currentSlide)) &&
            this.changeTo(i.index, !1, t, e)
          );
        }),
        ...
        (t.prototype.nextCarousel = function (t, e) {
          return (
            !!this.next(t, e) ||
            this.changeTo(this.getFirstSlide().index, !1, t, e)
          );
        }),
                    ...
                    if (this.mainAnimationLastChangeTime < n) {
                      ...
                      if ("ended" === r) {
                        ...
                        s !== o && (a = s),
                          ...
                          a.changeTo(this.currentSlide, this.slides[t], e, i),
        ...
        (t.prototype._changeTo = function (t, e, i, s) {}),
        ...
        (t.prototype.updateInsideSlides = function (t) {
          for (var e = 0; e < this.slides.length; e++)
            this.slides[e].setInside(t.indexOf(this.slides[e]) >= 0);
        }),
          ...
          "forced" === this.parameters.layerMode.mode &&
            j(
              ...
              function (t) {
                ...
                (t.detail.resolveHandled.handled = !0),
                  G(e.element, "layerAnimationCompleteOut", t.detail.resolve),
                  e.playOut();
              }.bind(this)
            ),
            j(
        ...
        (t.prototype.onMainAnimationStartSyncLayers = function (t, e) {
          ...
          "mainInStart" === t.inAnimation
            ...
            s.push(U(i.element, "mainAnimationStartInCancel", n));
        }),
        ...
        (t.prototype.slideToID = function (t, e, i) {
          for (var n = 0; n < this.realSlides.length; n++)
            if (+this.realSlides[n].id === t)
              return this.slide(this.getSlideIndex(n), e, i);
          var o = s.querySelector('[data-id="' + t + '"]');
          if ((o && (o = o.closest(".n2-ss-slider")), o))
            return (
              this.id === o.ss.id ||
              (et(s.scrollingElement, ht(o), 400), o.ss.slideToID(t, e, !0))
            );
        }),
        ...
        (t.prototype._deviceSlides = function (t) {
          for (
            var e = t.detail.device, i = 0;
            i < this.staticSlides.length;
            i++
          )
            this.staticSlides[i].setDevice(e);
          for (var s = 0; s < this.realSlides.length; s++)
            this.realSlides[s].setDevice(e);
        }),
        (t.prototype._resizeSlides = function (t) {
          for (
            var e = t.detail.ratios, i = 0;
            i < this.staticSlides.length;
            i++
          )
            this.staticSlides[i].resize(e);
          for (var s = 0; s < this.realSlides.length; s++)
            this.realSlides[s].resize(e);
        }),
    ...
    c.d("Stages", function () {
      ...
      return (
        (t.prototype.get = function (t) {
          return (
            this.stages[t] === o && (this.stages[t] = new e(t)), this.stages[t]
          );
        }),
        ...
        (t.prototype.done = function (t, e) {
          ...
          if ("string" == typeof t) i = this.get(t).getPromise();
            ...
            for (var s = [], n = 0; n < t.length; n++)
              s.push(this.get(t[n]).getPromise());
            i = Promise.all(s);
          }
          i.then(e);
        }),
    ...
    c.d("SmartSliderWidgets", function () {
      ...
      return (
        ...
        (t.prototype.getVerticalsHeight = function () {
          var t = 0;
          if (this._verticals)
            for (var e = 0; e < this._verticals.length; e++)
              t += this._verticals[e].offsetHeight;
          return t;
        }),
        (t.prototype.onReady = function () {
              ...
              if (i !== o) {
                for (var s = i.split(","), n = s.length - 1; n >= 0; n--) {
                  ...
                  if (2 === r.length) {
                    var a = parseInt(r[0]),
                      l = parseInt(r[1]);
                    if (a <= l) for (var h = a; h <= l; h++) s.push(h);
          ...
          if (t) {
            ...
            d({ detail: { targetSlide: this.slider.currentRealSlide } }),
        ...
        (t.prototype.flushAdvancedVariables = function () {
          for (var t = {}, e = 0; e < this.requiredVariables.length; e++)
            t[this.requiredVariables[e]] = this.getAdvancedVariable(
              this.requiredVariables[e]
            );
          ...
          if (this.slider.parameters.plugins.lightbox !== o) {
            ...
            for (var e = 0; e < this.slider.realSlides.length; e++)
              if (this.slider.realSlides[e].getLightboxImage()) {
                ...
                p(i, "data-force-pointer", "zoom-in"),
                  j(
                    i,
                    t,
                    function (t, e) {
            ...
            for (
              ...
              if (s) {
                ...
                switch (
                  ...
                  case "namemore":
                    P(n, "title", i.getTitle()),
                      P(n, "description", i.getDescription());
                }
                i.element.appendChild(n),
                  j(n, "click", function (t) {
                    t.stopPropagation();
                  }),
                  (i.element.lightbox = n),
    ...
    c.d("SmartSliderMainAnimationAbstract", function () {
      function t(t, e) {
        (this.state = "ended"),
          ...
          (this.slider = t),
          (this.parameters = d({ duration: 1500, ease: "easeInOutQuint" }, e)),
          ...
          j(
            ...
            "mainAnimationStart",
            function (t) {
              (this._revertCurrentSlideIndex = t.detail.previousSlideIndex),
                (this._revertNextSlideIndex = t.detail.currentSlideIndex);
            }.bind(this)
          ),
      ...
      return (
        ...
        (t.prototype._setTouchEndWithReverse = function (t, e, i) {
          t
            ? e < 0 && this.reverseTimeline.totalDuration() > 0
        ...
        (t.prototype.willRevertTo = function (t, e) {
          Z(this.slider.sliderElement, "mainAnimationWillRevertTo", {
            ...
            G(
              this.sliderElement,
              "mainAnimationComplete",
              this.revertTo.bind(this, t, e)
            );
        }),
        (t.prototype.revertTo = function (t, e) {
          this.slider.revertTo(t, e),
            Y(this.slider.slides[e].element, "mainAnimationStartInCancel");
        }),
        ...
        (t.prototype._initAnimation = function (t, e, i) {
        ...
        (t.prototype.onChangeToStart = function (t, e, i) {
          ...
          this.slider.h("mainAnimationStart", s),
            t.h("mainAnimationStartOut", s),
            e.h("mainAnimationStartIn", s);
        }),
        (t.prototype.onChangeToComplete = function (t, e, i) {
          ...
          this.clearTimelines(),
            ...
            t.h("mainAnimationCompleteOut", s),
            e.h("mainAnimationCompleteIn", s),
            (this.state = "ended"),
            this.slider.updateInsideSlides([e]),
            i || e.focus(),
            this.slider.h("mainAnimationComplete", s);
        }),
    ...
    c.d("SmartSliderPostBackgroundAnimation", function () {
      ...
      return (
        (i.prototype.init = function () {
          ...
          (this.tween = this.images[e].postBGTween),
            this.playFirst
              ? this.addVisiblePlay()
        ...
        (i.prototype.initImage = function (t, e) {
          e.hasImage()
            ? (e.postBGTween = this.getAnimation(t, e))
            : (e.postBGTween = !1);
        }),
        ...
        (i.prototype.getAnimation = function (i, s) {
          ...
          h.from.transformOrigin === o &&
            (h.from.transformOrigin = n.transformOrigin);
          ...
          for (var p = 0; p < h.strength.length; p++) {
            var u = h.strength[p];
            "scale" === u
              ? ((h.from.scale = 1 + (h.from.scale - 1) * e[a]),
                (h.to.scale = 1 + (h.to.scale - 1) * e[a]))
              : ((h.from[u] *= e[a]), (h.to[u] *= e[a]));
          }
          return (
            h.from.x !== o &&
              (h.from.x = function (t) {
            ...
            n2const.isFirefox &&
              ((h.from.rotationZ = 0.1), (h.to.rotationZ = 0.1)),
            c.MW.t(d, h.from),
            c.MW.flush(),
            c.K.fromTo(d, t[r], h.from, h.to)
          );
        }),
        (i.prototype.prepareToSwitchSlide = function (t, e) {
          t && this.images[t.index].postBGTween
            ...
            : (this.lastTween = !1),
            this.images[e.index].postBGTween
              ? (this.tween = this.images[e.index].postBGTween)
              : (this.tween = !1);
        }),
      ...
      return (
        ...
        (t.prototype.switchOnLoad = function () {
          ...
          if (t > 0) {
            ...
            s && s.stages.resolved("StarterSlide")
              ? s.stages.done(
                  "BeforeShow",
                  function () {
    ...
    c.d("SmartSliderControlAutoplay", function () {
      ...
      return (
          ...
          this._listeners.push(
              ...
              U(
                ...
                function (t) {
                  this.timeline.duration(
                    this.getSlideDuration(t.detail.currentSlideIndex)
                  ),
                    (this.rt = !0),
            ...
            this._listeners.push(
              U(
                ...
                function (t) {
                  this.timeline.duration(
                    this.getSlideDuration(t.detail.currentSlide.index)
                  ),
                    (this.rt = !0),
                    this.timeline.pause(0, !1),
                    this.setState("mainAnimationPlaying", 0);
          ...
          (t || e) &&
            (this.universalClick = new c.UniversalClick(
              ...
              function (i) {
                this.clickHandled ||
                  (this.state.pausedSecondary
                    ? e && this.setState("pausedSecondary", 0)
            ...
            this._listeners.push(
              ...
              this._listeners.push(
                U(
                  ...
                  function (s) {
                    this.state.pausedSecondary
                      ? "enter" === e && this.setState("pausedSecondary", 0)
                      : i ||
                        "enter" !== t ||
              ...
              this._listeners.push(
                U(
                  ...
                  function (i) {
                    this.state.pausedSecondary
                      ? "leave" === e && this.setState("pausedSecondary", 0)
        ...
        (t.prototype.getSlideDuration = function (t) {
          ...
          return (
            0 === parseFloat(e.minimumSlideDuration) &&
        ...
        (e.prototype.onKeyDown = function (t) {
          if (
            ...
            if (
              ...
              return void Z(e, "SliderKeyDown", { e: t });
            if (s.activeElement !== n && (e = this.findSlider(s.activeElement)))
              return void Z(e, "SliderKeyDown", { e: t });
            for (var i = 0; i < this.controls.length; i++)
              this.controls[i].onKeyDown(t);
          }
        }),
    ...
    c.d("SmartSliderControlMouseWheel", function () {
      ...
      return (
        (t.prototype.hasScrollableParentVertical = function (t, e) {
        ...
        (t.prototype.onGlobalMouseWheel = function (t) {
          t.target.closest(".n2-ss-slider") &&
            0 !== t[this.ut] &&
            (this.onCurveEvent(t),
            this.preventScroll.local ||
            this.preventScroll.curve ||
            Math.abs(t[this.ut]) < this.maxDelta / 2
              ? t.preventDefault()
              : (this.preventScroll.global && t.preventDefault(),
                (this.slider.sliderElement === t.target ||
                  this.slider.sliderElement.contains(t.target)) &&
                  ("deltaY" === this.ut
                    ? t.shiftKey ||
                      ...
                      this.onMouseWheel(t)
                    : "deltaX" === this.ut &&
                      (this.hasScrollableParentHorizontal(t.target) ||
                        this.onMouseWheel(t)))));
        }),
        ...
        (t.prototype.onCurveEvent = function (t) {
          if (this.preventScroll.curveGlobal) {
            this.dynamicDelta ||
              this.lastDelta === t[this.ut] ||
              ((this.lastDelta = t[this.ut]), (this.dynamicDelta = !0));
      ...
      return (
          ...
          if (!s || "unknown" !== this.currentInteraction.action) {
            ...
            if (
              ((this.currentInteraction.hadDirection ||
                Math.abs(n) > 10 ||
                Math.abs(i.y) > 10) &&
                (this.logDistance(n, i.y),
                this.currentInteraction.percent < 1 &&
                  this.setTouchProgress(n, i.y),
        ...
        (t.prototype._end = function (t, e, i, s) {
          ...
          this.onEnd(),
            ...
            Math.abs(i.x) < 10 && Math.abs(i.y) < 10
              ? this.onTap(t)
              : c._preventClick();
        }),
        ...
        (t.prototype.setTouchProgress = function (t, e) {
          ...
          var i,
            s = this.getPercent(t - this.currentInteraction.startDistance);
          if (
            ((this.currentInteraction.percent = s),
            "switch" === this.currentInteraction.action)
          ) {
        ...
        (t.prototype.recognizeSwitchInteraction = function () {
          if (
            ...
            if ("ended" === this._animation.state) {
              ...
              "unknown" !== t &&
                this.currentInteraction.state[t] &&
                ((this.currentInteraction.animationStartDirection = t),
                this.interactiveDrag &&
                  (this._animation.setTouch(this.axis), this.callAction(t, !1)),
        ...
        (t.prototype.logDistance = function (t, e) {
          this.currentInteraction.distance.length > 3 &&
            ...
            this.currentInteraction.distanceY.push({ d: e, t: Date.now() });
        }),
        ...
        (t.prototype.setState = function (t, e) {
          "object" != typeof arguments[0] &&
            (((t = {})[arguments[0]] = arguments[1]), (e = arguments[2]));
          var i = !1;
          for (var s in t)
            this.state[s] !== t[s] && ((this.state[s] = t[s]), (i = !0));
          i &&
            e &&
    ...
    c.d(
      ...
      function () {
        ...
        return (
          ...
          (t.prototype.callAction = function (t, e) {
            switch (t) {
              case "left":
          ...
          (t.prototype.updatePanDirections = function () {
            var t = this.slider.currentSlide.index,
              ...
              i = t - 1 >= 0;
            this.slider.parameters.carousel && ((e = !0), (i = !0)),
              n2const.isRTL() && "vertical" !== this.slider.getAnimationAxis()
                ? this.setState({ right: e, left: i }, !0)
                : this.setState({ right: i, left: e }, !0);
          }),
      ...
      return (
        ...
        (t.prototype.resolveWeak = function () {
          ...
          for (var i in this.waits)
            1 === this.waits[i] && -1 !== t.Strong.indexOf(i) && (e[i] = 1);
    ...
    c.d("SmartSliderSlideBackgroundImage", function () {
      function t(t, e, i, s) {
        (this.slide = t),
          ...
          (this.imageElements = Array.from(s));
      }
      return (
        (t.prototype.getLoadPromise = function () {
          return this._promise;
        ...
        (t.prototype.preLoad = function () {
          ...
          (i.loading = "eager"),
            i.complete
              ...
              : (i.addEventListener("load", this.onImageLoaded.bind(this, i)),
                i.addEventListener("error", this.onImageLoaded.bind(this, i)));
        }),
          ...
          this.isReady ||
              ...
              function (t) {
                this.setState(
                  ...
                  this.slide.isActiveWhen(
                    this.slider.slides[t.detail.currentSlideIndex]
                  ),
                  !0
                );
              }.bind(this)
            ...
            j(
              ...
              function (t) {
                this.setState(
                  "slide",
                  this.slide.isActiveWhen(t.detail.currentSlide),
                  !0
                );
              }.bind(this)
            ),
        ...
        (t.prototype.preloadOnce = function () {
          if (!this.elements) {
            ...
            s &&
              s.strength > 0 &&
              !(
                (n2const.isPhone && !s.mobile) ||
                (n2const.isTablet && !s.tablet)
              ) &&
              this.hasBackground() &&
        ...
        (t.prototype.createLayerAnimations = function (t, e) {
          ...
          if (!n2const.isBot) {
            if (!this.skipSelfAnimation) {
              var s = new c.FrontendLayerAnimationManager(
                this,
                this.layer,
                this.getAnimatableElement(),
                this.slide.getPerspective()
              );
              s.setEventBased(this.slide.realSlide, t, e),
                s.hasAnimation()
                  ? ((this.animationManager = s), i.push(s))
          ...
          if (t)
            for (var e = 0; e < t.length; e++) {
              ...
              switch (A(i, "sstype")) {
                case "content":
                  this.children.push(
                    new c.FrontendComponentContent(this.slide, this, i)
                  );
                  break;
                case "row":
                  this.children.push(
                    new c.FrontendComponentRow(this.slide, this, i)
                  );
                  break;
                case "col":
                  this.children.push(
                    new c.FrontendComponentCol(this.slide, this, i)
                  );
                  break;
                default:
                  this.children.push(
                    new c.FrontendComponentLayer(this.slide, this, i)
                  );
              }
            }
    ...
    c.d("FixedBackground", function () {
      var t = function () {
        ...
        var e,
          s = Math.abs(i.orientation),
          n = { w: 0, h: 0 };
        return (
          ((e = l()).style.position = "fixed"),
          (e.style.height = "100vh"),
          (e.style.width = 0),
          (e.style.top = 0),
          h.appendChild(e),
          (n.w = 90 === s ? e.offsetHeight : i.innerWidth),
          (n.h = 90 === s ? i.innerWidth : e.offsetHeight),
          h.removeChild(e),
          (e = null),
          (t = function () {
      ...
      return {
        ...
        addElement: function (t, e) {
          ...
          this.elements.push(i),
            (i.animatedSMW.backfaceVisibility = "hidden"),
            (i.animatedSMW["will-change"] = "transform"),
      ...
      return (
        ...
        (t.prototype.enable = function () {
          ...
          if (
            ...
            (this._scrollCallback = this.scroll.bind(this, e, s, n)),
              this._listeners.push(
              ...
              for (var e = 0; e < this.slider.staticSlides.length; e++)
                this.parallaxedStaticSlideNodes =
                  this.parallaxedStaticSlideNodes.concat(
                    this.slider.staticSlides[e].getParallaxNodes()
                  );
            this.firstStart = !1;
          }
          if (
        ...
        (t.prototype.mouseEnter = function (t) {
          this.ticking || (c.l.add(this.lt), (this.ticking = !0)),
            this.refreshSliderDimension(),
            t && "enter" === this.parameters.origin
              ? (this.mouseOrigin = { x: t.clientX, y: t.clientY })
              : (this.mouseOrigin = this.dimensions);
        }),
        (t.prototype.mouseMove = function (t, e, i) {
          !1 !== this.mouseOrigin &&
            (this.mouseX &&
              ((this.x = t * (i.clientX - this.mouseOrigin.x)),
              this.parameters.is3D &&
                (this.rotationY = -this.x / this.dimensions.w2)),
            this.mouseY &&
              ((this.y = e * (i.clientY - this.mouseOrigin.y)),
              this.parameters.is3D &&
        ...
        (t.prototype.mouseLeave = function (t) {
          ...
          var e = {};
          this.mouseX && (e.parallaxX = 0),
            this.mouseY && (e.parallaxY = 0),
            this.parameters.is3D &&
              (e.parallaxRotationX = e.parallaxRotationY = 0),
            c.K.to(t ? c.MW.L(this.parallaxedSlideNodes) : this.dt, 2, e);
        }),
        (t.prototype.getScrollTopRecursive = function (t, e) {
          return null === t || t.scrollTop === o
            ? e
            : ((e += t.scrollTop), this.getScrollTopRecursive(t.parentNode, e));
        }),
          ...
          if (this.parallaxedNodes)
            for (var t = 0; t < this.parallaxedNodes.length; t++) {
              ...
              if (this.parameters.is3D) {
                ...
                (s.parallaxRotationX = this.rotationX * n),
                  (s.parallaxRotationY = this.rotationY * n);
              }
              (s.parallaxX = Math.round(this.x * i)),
                (s.parallaxY = Math.round(this.y * i)),
                this.render(this.dt[t], s);
            }
        }),
    ...
    c.d("FrontendSliderSlide", ["FrontendSliderSlideAbstract"], function () {
      function t(t, e, i) {
        (this.slides = [this]),
          ...
          (this.id = A(e, "id")),
          (this._slideFocus = e.querySelector(".n2-ss-slide--focus")),
        ...
        var s = v(e, "tabindex");
        ("0" === s || +s > 0) && this.focusableElements.push(e),
          this.disableFocus(),
          (this.background = !1),
          t.parameters.admin
            ? (this.minimumSlideDuration = 0)
            : ((this.minimumSlideDuration = +A(e, "slideDuration")),
              this.minimumSlideDuration || (this.minimumSlideDuration = 0)),
          (this._isCurrentlyEdited =
            this.slider.parameters.admin &&
            e.classList.contains("n2-ss-currently-edited-slide")),
          this.isCurrentlyEdited()
            ? ((this.layer = e.querySelector(
            ...
            : ((this.component = new c.FrontendComponentSectionSlide(
                this,
                t,
                e.querySelector('.n2-ss-layer[data-sstype="slide"]')
              )),
      ...
      return (
        (t.prototype.focus = function () {
          e && this._slideFocus.focus({ preventScroll: !0 });
        }),
    ...
    c.d("FrontendSliderSlideAbstract", ["FrontendSlideControls"], function () {
      function t(t, e, i) {
        c.FrontendSlideControls.prototype.constructor.call(this, t, e),
      ...
      for (var e in c.FrontendSlideControls.prototype)
        t.prototype[e] = c.FrontendSlideControls.prototype[e];
      return (
    ...
    c.d("FrontendPlacementAbsolute", ["FrontendPlacement"], function () {
      ...
      return (
        (e.prototype = Object.create(c.FrontendPlacement.prototype)),
        ...
        (e.prototype.onResizePosition = function () {
          ...
          this.isSingleAxis() && (n = s),
            parseInt(this.layer.get("responsiveposition")) || (s = n = 1);
          ...
          if (
            ...
            if (
              ...
              (h.left += p.xAbs + (p.xPAbs / 100) * h.width),
                (h.top += p.yAbs + (p.yPAbs / 100) * h.height);
            }
    ...
    c.d("FrontendComponentCol", ["FrontendComponentCommon"], function () {
      function t(t, e, i) {
        (this.content = i.querySelector(".n2-ss-layer-col")),
    ...
    c.d("FrontendComponentContent", ["FrontendComponentCommon"], function () {
      function t(t, e, i) {
        (this.content = i.querySelector(".n2-ss-section-main-content")),
          c.FrontendComponentCommon.prototype.constructor.call(
            this,
            t,
            e,
    ...
    c.d("FrontendComponentLayer", ["FrontendComponentCommon"], function () {
      function t(t, e, i) {
        ...
        var s = i;
        this.wraps.mask && (s = this.wraps.mask),
          (this.item = s.querySelectorAll(":scope > *"));
      }
      return (
        (t.prototype = Object.create(c.FrontendComponentCommon.prototype)),
        (t.prototype.constructor = t),
    ...
    c.d("FrontendComponentRow", ["FrontendComponentCommon"], function () {
      function t(t, e, i) {
        (this.row = i.querySelector(".n2-ss-layer-row")),
          (this.rowInner = i.querySelector(".n2-ss-layer-row-inner")),
          c.FrontendComponentCommon.prototype.constructor.call(
            this,
            t,
            e,
      ...
      function t(t, e, i) {
        (this.realSlide = t),
          ...
          c.FrontendComponent.prototype.constructor.call(
            ...
            this,
            i,
            i.querySelectorAll(":scope > .n2-ss-layer")
          ),
          j(
            e.sliderElement,
            "SliderDeviceOrientation",
    ...
    c.d("FrontendLayerAnimationManager", function () {
      ...
      return (
        (t.index = 1),
        (t.optimizeFromTo = function (t, e, i, s, n, o) {
          t.fromTo(e, i, s, n, o);
        }),
        ...
        (t.prototype.collectRelatedAnimations = function () {
          ...
          for (var t = 0; t < e.keys.length; t++) {
            ...
            this.options[i] &&
              ...
              this.plugins[i].collectRelatedAnimations(
                this.relatedAnimations,
                this,
                this.options[i]
              ));
        ...
        (t.prototype.buildTimeline = function () {
          ...
          for (t = 0; t < this.relatedAnimations.in.length; t++)
            this.relatedAnimations.in[t].extendTimeline(i);
          i.totalDuration()
            ? (this.linear ||
                i.eventCallback("onComplete", this.inComplete.bind(this)),
              (this.inStatus = !0),
              this.timeline.add(i))
            : (i.kill(), (this.inStatus = !1)),
          ...
          for (t = 0; t < this.relatedAnimations.out.length; t++)
            this.relatedAnimations.out[t].extendTimeline(s);
            ...
            s.totalDuration()
              ? (this.linear
                  ...
                  : (this.timeline.addLabel("OUT", "+=0.001"),
                    ...
                    s.set({}, {}, "+=" + n),
                    s.eventCallback("onComplete", this.outComplete.bind(this))),
                (this.outStatus = !0),
                this.timeline.add(s))
              : (s.kill(),
                (this.outStatus = !1),
        ...
        (t.prototype.refreshRatio = function (t, e) {
          if (
            (this.updateRatios(t, e), this.relatedAnimations.needInvalidate)
          ) {
        ...
        (e.keys = ["basic", "reveal"]),
        (e.prototype.initPlugin = function (t, e, i) {
          switch (t) {
            case "basic":
      ...
      function () {
        ...
        function i(e, i) {
          (this.device = "desktopPortrait"),
            ...
            (this.isAbsolute = "absolute" === A(e, "pm")),
            (this.At = !1),
        ...
        (i.prototype = Object.create(
          ...
          (i.prototype.updateRatios = function (t, e) {
          ...
          (i.prototype.optimizeFromTo = function (t, e, i, s, n, o) {
            this.hadImmediateRender
              ...
              c.FrontendLayerAnimationManager.optimizeFromTo(t, e, i, s, n, o);
          }),
          ...
          (i.prototype.collectRelatedAnimations = function (e, i, s) {
            if (
              ...
              this.At && e.other.push(this),
              this.options.in.keyFrames.length &&
                e.in.push(new c.AnimationsRelated(this, "extendTimelineIn")),
            ...
            this.options.out.keyFrames.length &&
              e.out.push(new c.AnimationsRelated(this, "extendTimelineOut")),
              e.setDevice.push(this);
          }),
          ...
          (i.prototype.optimizeKeyFrames = function () {
            ...
            for (i = 0; i < n.length; i++)
              (t = n[i] = this._fillKeyFrame(n[i])),
                this.prepareDeviceSpecific(t, 1);
            for (i = 0; i < o.length; i++)
              (t = o[i] = this._fillKeyFrame(o[i])),
                this.prepareDeviceSpecific(t, 1);
            for (
              this._cleanKeyFrame(this.currentZero), i = 0;
              i < s.length;
              i++
            )
              s[i] = this._cleanKeyFrame(s[i]);
        ...
        (i.prototype._fillKeyFrame = function (t) {
          for (var e in s)
            t[e] !== o && t[e] != s[e] && (this.usedProperties[e] = !0);
          return d(
            {
              duration: 0.8,
              delay: 0,
          ...
          (i.prototype._cleanKeyFrame = function (t) {
            for (var e in (delete t.name, this.usedProperties))
              this.usedProperties[e] || delete t[e];
            return t;
          });
        var n = [
          "desktopLandscape",
        ...
        return (
          (i.prototype.prepareDeviceSpecific = function (t, e) {
          ...
          (i.prototype.prepareDeviceSpecificProp = function (t, e, i) {
            ...
            this.isAbsolute
              ...
              : (e[t] = r.desktopPortrait);
          }),
          (i.prototype.extendTimelineIn = function (t) {
            (this.It.transformOrigin = e(this.options.in.transformOrigin)),
          ...
          (i.prototype._buildAnimationChainIn = function (t) {
            for (
              var e = [{ from: this.currentZero }], i = t.length - 1;
              i >= 0;
              i--
            ) {
              var s = m({}, t[i]),
          ...
          (i.prototype._buildAnimationChainOut = function (t) {
            ...
            delete i.transformOrigin, e.push({ to: i });
            for (var s = 0; s < t.length; s++) {
              var n = m({}, t[s]),
                o = n.duration;
              delete n.duration;
        ...
        return (
          ...
          (e.prototype.collectRelatedAnimations = function (t, e, i) {
            (this.animationManager = e),
              ...
              (i.in === o && i.out === o) ||
                ...
                i.in !== o &&
                  ((this.in = this._initGroup("in", i)),
                  t.in.push(new c.AnimationsRelated(this, "extendTimelineIn"))),
                i.out !== o &&
                  ((this.out = this._initGroup("out", i)),
                  t.out.push(
          ...
          (e.prototype._initGroup = function (e, i) {
            ...
            return (
              ...
              this.animatableElement.appendChild(s),
              n
            );
          }),
      ...
      var t = function (t, e, i) {
          ...
          switch (t) {
            ...
            case "curtains-diagonal-1":
              ...
              return [
                ot("polygon", { points: "0,0 33,0 0,33", fill: "#" + i }, o),
                ot(
                  "polygon",
                  { points: "32,32 32,-1 -1,32", fill: "#" + i },
                  o
                ),
              ];
            case "curtains-diagonal-2":
              return (
                ...
                [
                  ot(
                    "polygon",
                    { points: "0,32 33,32 0,-1", fill: "#" + i },
                    o
                  ),
                  ot(
                    "polygon",
                    { points: "32,0 32,33 -1,0", fill: "#" + i },
                    o
                  ),
                ]
              );
            ...
            case "circle-left":
              (s = l()),
                x(s, { "border-radius": "100%", background: "#" + i }),
                e.appendChild(s);
                ...
                switch (e) {
                  ...
                  case "circle-bottom":
                    s =
                      2 *
                      Math.ceil(
                        Math.sqrt((i.width * i.width) / 4 + i.height * i.height)
                      );
                    break;
                  case "circle-right":
                  case "circle-left":
                    s =
                      2 *
                      Math.ceil(
                        Math.sqrt(i.width * i.width + (i.height * i.height) / 4)
                      );
                }
                x(t, {
                  "margin-top": -s / 2 + "px",
        ...
        e = function (t, e, i, n, r, a) {
          ...
          for (var d = 0; d < l.length; d++)
            l[d].a.transformOrigin &&
              (t.set(e[d], { transformOrigin: l[d].a.transformOrigin }, h),
              delete l[d].a.transformOrigin),
              (l[d].b.ease = n),
              t.fromTo(e[d], i, l[d].a, l[d].b, h);
        },
        i = function (t, e, i, n, r, a, l) {
          var h = s(a, l);
          h.length === o && (h = [h]);
          for (var d = 0; d < h.length; d++)
            h[d].a.transformOrigin &&
              (t.set(e[d], { transformOrigin: h[d].a.transformOrigin }, n),
              delete h[d].a.transformOrigin),
              (h[d].a.ease = r),
              t.fromTo(e[d], i, h[d].b, h[d].a, n);
        },
        s = function (t, e) {
          var i, s, n;
          switch (t) {
            ...
            case "skew-top":
              return (
                ...
                (s = 20),
                (n = Math.cos(((90 - s) * Math.PI) / 180) * i.width),
                {
                  a: { y: -1 * (i.height + n), skewY: -s },
                  b: { y: 0, skewY: 0 },
                }
              );
            case "skew-right":
              return (
                (i = e.getBoundingClientRect()),
                (s = 20),
                (n = Math.cos(((90 - s) * Math.PI) / 180) * i.height),
                { a: { x: i.width + n, skewX: -s }, b: { x: 0, skewX: 0 } }
              );
            case "skew-bottom":
              return (
                (i = e.getBoundingClientRect()),
                (s = 20),
                (n = Math.cos(((90 - s) * Math.PI) / 180) * i.width),
                { a: { y: i.height + n, skewY: s }, b: { y: 0, skewY: 0 } }
              );
            case "skew-left":
              return (
                (i = e.getBoundingClientRect()),
        ...
        n = function (t, e) {
          ...
          switch (t) {
            case "fade":
              (i = { opacity: 0 }), (s = { opacity: 1 });
              break;
            case "scale-up":
              (i = { scale: 0.7 }), (s = { scale: 1 });
              break;
            case "scale-down":
              (i = { scale: 1.3 }), (s = { scale: 1 });
              break;
            case "top":
              (i = { yP: -100.1 }), (s = { yP: 0 });
              break;
          ...
          return "out" === e ? { from: s, to: i } : { from: i, to: s };
        };
      return {
        in: function (s, r) {
          ...
          s.add(a), s.set(r.clipSMW, { visibility: "visible" }, 0);
          ...
          c.MW.t(d, { visibility: "hidden" }),
            ...
            "no" !== r.options.from
              ? (c.MW.t(p, { visibility: "hidden" }),
                a.set(d, { visibility: "visible" }),
                e(a, d, h, r.options.fromease, r.options.from, r.clip),
                a.set(d, { visibility: "hidden" }),
                a.set(p, { visibility: "visible" }))
          ...
          m
            ? (m.from.opacity === o &&
              ...
              (m.to.ease = "easeOutCubic"),
              a.fromTo(r.revealedElementSMW, h, m.from, m.to))
            : a.set(r.revealedElementSMW, { opacity: 1 }),
            i(a, p, h, u, r.options.toease, r.options.to, r.clip),
            a.set(p, { visibility: "visible" }),
        ...
        out: function (s, r) {
          ...
          m
            ? (m.from.opacity === o &&
              ...
              (m.to.ease = "easeOutCubic"),
              a.fromTo(r.revealedElementSMW, h, m.from, m.to, u - h))
            : a.set(r.revealedElementSMW, { opacity: 0 }),
            (u = a.totalDuration()),
            a.set(p, { visibility: "visible" }, u),
            i(a, p, h, u, r.options.toease, r.options.to, r.clip),
            a.set(p, { visibility: "hidden" }),
            a.set(r.clipSMW, { visibility: "hidden" });
        },
      };
    }),
      ...
      function () {
        ...
        return (
          ...
          (t.prototype.buildTimeline = function (t) {
            ...
            for (
              var e = 0;
              e < this.animationManager.relatedAnimations.loop.length;
              e++
            )
              this.animationManager.relatedAnimations.loop[e].setController(
                this,
                e
              ),
                this.animations.push(
                  this.animationManager.relatedAnimations.loop[e]
                );
            if (this.animations.length > 0) {
              ...
              for (
                this.animations[0].buildTimeline(t, i), e = 1;
                e < this.animations.length;
                e++
              )
                this.animations[e].buildTimeline(
                  !!this.animationManager.linear && t,
                  this.animationManager.linear ? i : 0
                );
            }
      ...
      return (
        ...
        (t.prototype.buildTimeline = function (t, e) {
          ...
          (this.timeline = t || new c.J({ paused: !0 })),
            ...
            this.repeatStartDelay > 0 &&
              ((e += this.repeatStartDelay), this.timeline.set({}, {}, e)),
            this.buildTimelineLoop(e, i, m([], this.animationData)),
            this.animationManager.linear ||
              this.timeline.set({}, { onComplete: this.onComplete.bind(this) });
        }),
        (t.prototype.buildTimelineLoop = function (t, e, i) {
          var s,
            n = this._buildAnimationChainLoop(i);
            ...
            for (var a = 0; a < r; a++)
              for (s = 0; s < n.length; s++)
                c.FrontendLayerAnimationManager.optimizeFromTo(
                  ...
                  n[s].duration,
                  d({}, n[s].from),
                  d({ immediateRender: !1 }, n[s].to),
                  t
                ),
                  (t += n[s].duration + (n[s].to.delay ? n[s].to.delay : 0));
          } else if ("event" === e) {
            for (this.timeline.addLabel("LOOP", t), s = 0; s < n.length; s++)
              (n[s].to.immediateRender = !1),
                c.FrontendLayerAnimationManager.optimizeFromTo(
                  this.timeline,
                  this.It,
                  n[s].duration,
        ...
        (t.prototype._buildAnimationChainLoop = function (t) {
          ...
          if (1 === t.length) {
            this.single = !0;
            var i = m({}, t[0]);
            ((e = d({}, this.layerAnimations.currentZero)).duration =
              i.duration),
              (e.ease = i.ease),
              (360 !== Math.abs(i.rotationX) &&
                360 !== Math.abs(i.rotationY) &&
                360 !== Math.abs(i.rotationZ)) ||
              (1 != i.opacity && i.opacity !== o) ||
              (0 != i.x && i.x !== o) ||
              (0 != i.y && i.y !== o) ||
              (0 != i.z && i.z !== o) ||
              (1 != i.scaleX && i.scaleX !== o) ||
              (1 != i.scaleY && i.scaleY !== o) ||
              (0 != i.skewX && i.skewX !== o) ||
              (0 != i.n2blur && i.n2blur !== o)
                ? t.push(e)
                : (360 == +i.rotationX
                    ? (i.rotationX = "+=360")
                    : -360 == +i.rotationX && (i.rotationX = "-=360"),
                  360 == +i.rotationY
                    ? (i.rotationY = "+=360")
                    : -360 == +i.rotationY && (i.rotationY = "-=360"),
                  360 == +i.rotationZ
                    ? (i.rotationZ = "+=360")
                    : -360 == +i.rotationZ && (i.rotationZ = "-=360"));
          }
          var s = 0,
            n = [
              {
    ...
    c.d("AnimationsLoopTimeline", ["AnimationsLoopAbstract"], function () {
      function t(t, e) {
        (this.manager = t),
          c.AnimationsLoopAbstract.prototype.constructor.call(this, e);
      }
      return (
    ...
    c.d("AnimationsLoopAbstract", function () {
      ...
      return (
        (t.prototype.setController = function (t, e) {
    ...
    c.d("SmartSliderResponsive", function () {
      let t,
        e = !1;
      function l(t, e) {
        for (var s in ((this.state = { StarterSlide: !1 }),
        (this.isVisible = !0),
        ...
        this.parameters.mediaQueries))
          this.parameters.mediaQueries[s] &&
            (this.mediaQueries[s] = i.matchMedia(
              this.parameters.mediaQueries[s].join(",")
            ));
      ...
      return (
              ...
              for (
                var e = new ResizeObserver(
                    function (t) {
                      ...
                      for (var e = 0; e < t.length; e++)
                        this.focusOffsetTop +=
                          t[e].target.getBoundingClientRect().height;
                      this.Et();
                    }.bind(this)
                  ),
                  i = 0;
        ...
        (l.prototype.doResize = function (t) {
          ...
          if (this.parameters.hideOn[l._DeviceMode[i]])
          ...
          if (
            (this.deviceID !== i &&
              (this.setDeviceID(i),
              n && N(this.sliderElement, "n2-ss-" + n),
            ...
            return (
              (this.parameters.hideOn[l._DeviceMode[i]] = !0),
              F(this.v, "n2-section-smartslider--hidden"),
              !1
            );
          if (this.slider.isVisible || this.visibleRealSlidesChanged) {
            for (var o = 0; o < this.slider.realSlides.length; o++)
              c.MW.i(this.slider.realSlides[o].element).setValues({
                width: "",
                height: "",
              }),
                x(this.slider.realSlides[o].element, { width: "", height: "" });
        ...
        (l.prototype.finalizeVisibleSlidesStage1 = function () {
          this.visibleRealSlidesChanged &&
            (this.slider.visibleRealSlides.sort(function (t, e) {
        ...
        (l.prototype.calibrateActiveSlide = function (t) {
          if (this.state.StarterSlide && this.slider.visibleSlides.length > 0) {
            ...
            e.isVisible ||
              (e = e.getNext()) ||
              (e = this.slider.currentSlide.getPrevious()),
        ...
        (l.prototype.resetActiveRealSlide = function (t) {
          ...
          t && t !== this.slider.currentRealSlide
            ? (this.slider.h("BeforeCurrentSlideChange", t),
              (e = this.slider.currentSlide) &&
                this.slider.forceUnsetActiveSlide(e),
        ...
        (l.prototype.filterSliderWidthHorizontalSpacing = function (t) {
          for (var e in ((this.horizontalSpacing = { right: 0, left: 0 }),
          this.horizontalSpacingControls))
            for (
              var i = this.horizontalSpacingControls[e], s = i.length - 1;
              s >= 0;
              s--
            ) {
              var n = i[s];
    ...
    c.d("FrontendItemAnimatedHeading", function () {
      ...
      function e(t, e) {
        if (
          ...
          (this.listeners = []),
          n2Slow || e.disabled.layerAnimations)
        )
          T(this.Rt.slice(1));
        else {
          this.Tt = c.MW.i(t);
      ...
      return (
        ...
        (e.prototype.started = function () {
          ...
          switch ((this.loop && s++, this.currentType.fn)) {
            case "animateWhole":
              ...
              this.animateWidth
                ? (n = 0.4 * 0.8)
                : (o = e.overlap * this.speedModifier),
                (this.totalDuration =
                  (s - 1) * this.showDuration +
                  2 * (s - 1) * e.duration * this.speedModifier +
                  (s - 1) * n -
                  (s - 1) * o);
              break;
            case "animateTypeWriter":
              for (var r = 0; r < s; r++) {
                ...
                r > 0 &&
                  ...
                  r < s - 1 &&
                    (this.totalDuration += e.backspaceDuration.call(this, a));
              }
              break;
            case "animateChars":
              for (o = 0, r = 0; r < s; r++)
                (a = this.getSplitTextChars(this.Rt[i === r ? 0 : r])),
                  r > 0 &&
                    (this.totalDuration += Math.max(
                      o,
                      e.duration * this.speedModifier +
                        (a.length - 1) * e.stagger
                    )),
                  r < s - 1 &&
        ...
        (e.prototype.collectRelatedAnimations = function (t) {
          ...
          1 === this.loop
            ...
            : e.in.push(new c.AnimationsRelated(this, "extendTimeline"));
        }),
        ...
        (e.prototype.getSplitTextChars = function (t) {
          ...
          if (!e) {
            var i = c.tt(t, !0);
            t.splitTextChars = e = Array.prototype.filter.call(
              i.chars,
              function (t) {
          ...
          for (var n = 0; n < s; n++) {
            ...
            if (
              ...
              this.timeline.staggerFromTo(
                ...
                d({}, t.from),
                d({ immediateRender: n < i, ease: t.ease }, t.current),
                t.stagger,
                a
              ),
                this.animateWidth &&
        ...
        (e.prototype.animateTypeWriter = function (t) {
          ...
          for (var s = 0; s < i; s++) {
            ...
            s > 0 &&
              (this.timeline.set(this.Ft[e === s ? 0 : s], {
                display: "inline-block",
                immediateRender: e !== s,
              }),
              this.timeline.staggerFromTo(
            ...
            if (s > 0) {
              ...
              this.animateWidth
                ? (this.timeline.to(
                  ...
                  (r += 0.4 * 0.8))
                : (r -= t.overlap * this.speedModifier),
                this.timeline.fromTo(
                  this.Ft[n],
                  t.duration * this.speedModifier,
                  d({}, t.from),
                  d({ immediateRender: s < e, ease: t.ease }, t.current),
                  r
                );
            }
            s < i - 1 &&
              this.timeline.fromTo(
                ...
                t.duration * this.speedModifier,
                d({}, t.current),
                d({ immediateRender: 0 === s, ease: t.ease }, t.to),
                "+=" + this.showDuration
              );
          }
          this.Nt.push(
      ...
      return (
        ...
        (t.prototype.updateUITime = function (t) {
          ...
          this.audio.currentTime =
            ...
            Math.max(
              0,
              Math.min(0.99, Math.round(t.clientX - e.left) / e.width)
            );
        }),
        (t.prototype.updateUIVolume = function (t) {
          ...
          this.audio.volume = Math.max(
            0,
            Math.min(1, Math.round(t.clientX - e.left) / e.width)
          );
        }),
      ...
      class t {
        ...
        qt() {
          ...
          "ontouchstart" in i &&
            ...
            (t = "pointerdown")),
            this.Vt.addEventListener(t, (t) => {
              if (!t.isPrimary || ("drag" === this.zt && 0 !== t.button))
                return;
              let e = [],
                s = 0,
                o = !1;
              n2const.isIOS &&
                ...
                e.push(
                  U(this.Vt, "touchmove", (i) => {
                    s++,
                      s > 5 &&
                        (!o && this.__preventTouchAction(t, i)
                          ? B(e)
                          : (i.preventDefault(), (o = !0)));
                  })
                ),
                this.setMoveEvents(t),
                e.push(
                  U(n, "pointermove", (t) => {
      ...
      return (
        ...
        (t.prototype.refresh = function (t) {
          ...
          const s = Math.floor(t / 60),
            n = (t -= 60 * s);
          this.bi !== e &&
            ((this.bi = e), (this.day.innerText = this.formatNumber(e))),
            this.yi !== i &&
              ((this.yi = i), (this.hour.innerText = this.formatNumber(i))),
            this.wi !== s &&
              ((this.wi = s), (this.minute.innerText = this.formatNumber(s))),
            this.gi !== n &&
    ...
    c.d("FrontendItemCounter", function () {
      ...
      return (
        ...
        (t.prototype._animateData = function (t, e) {
          return { percent: t, ease: (e = e || "easeOutExpo") };
        }),
    ...
    c.d("FrontendItemHighlightedHeading", function () {
      ...
      return (
        ...
        (t.prototype.collectRelatedAnimations = function (t) {
          var e = t.relatedAnimations;
          1 === this.loop
            ? e.loop.push(new c.AnimationsLoopTimeline(this, 0))
            : e.in.push(new c.AnimationsRelated(this, "extendTimeline"));
        }),
        ...
        (t.prototype.getTimeline = function () {
          if (this.timeline === o) {
            for (
              var t = new c.J({ paused: 1 }), e = 0;
              e < this.paths.length;
              e++
            )
              this.animatePath(t, this.paths[e], 0.6 * this.duration * e);
            this.loop &&
              this.loopDelay >= 0 &&
              (t.to(
                c.MW.L(this.paths),
        ...
        (t.prototype.animatePath = function (t, e, i) {
          ...
          t.fromTo(s, 0.1, { opacity: 0 }, { opacity: 1 }, i),
            t.fromTo(
              s,
              this.duration,
    ...
    c.d("FrontendItemHeadingSplitText", function () {
      ...
      return (
        (e.prototype.start = function (t, e, i, s, n, o) {
        ...
        (e.prototype.started = function (t, e, i, s, n, o) {
          ...
          for (var h in ((this.in.options || this.out.options) &&
            this.listeners.push(
              q(
                this.layerElement,
                "collectRelatedAnimations",
          ...
          l))
            l[h] &&
              c.MW.X(this.splitText[h]).setValues({
                "transform-origin": t,
        ...
        (e.prototype.getTimelineOut = function () {
          ...
          var e = this.out.options,
            i = { ease: e.ease };
          return (
            this.in.timeline && (i.immediateRender = !1),
            this._animate(
              this.out.timeline,
              e.mode,
              e.sort,
        ...
        (e.prototype._animate = function (t, e, i, s, n, o, r) {
          ...
          t.staggerFromTo(c.MW.L(a), s, n, o, r, 0),
            l && l.length && t.staggerFromTo(c.MW.L(l), s, n, o, r, 0);
        }),
    ...
    c.d("FrontendItemTransition", function () {
      function t(t, e, i) {
        ...
        var n = s.getElementById(e);
        j(n, "mouseenter", this["in" + i].bind(this)),
          j(n, "mouseleave", this["out" + i].bind(this)),
    ...
    c.d("FrontendItemVideo", function () {
      ...
      function e(e, i, n, o) {
        (this.state = {
          ...
          (this.slide = e.findSlideByElement(this.playerElement)),
          (this.isStatic = this.slide.isStatic()),
      ...
      return (
        (e.prototype.fadeOutCover = function () {
      ...
      return (
        ...
        (t.prototype.initYoutubePlayer = function () {
          ...
          for (var n in (n2const.isIOS &&
            ...
            (e.use_native_controls = 1),
          1 == this.parameters.center && (e.controls = 0),
          1 != this.parameters.controls && ((e.autohide = 1), (e.controls = 0)),
          +(
        ...
        (t.prototype.onResize = function () {
          var t = this.playerElement.parentNode.getBoundingClientRect(),
            ...
            i = t.height + 100,
            s = 16 / 9,
            n = { width: e + "px", height: i + "px", "margin-top": 0 };
          (n[n2const.rtl["margin-left"]] = 0),
            e / i > s
              ? ((n.height = e * s + "px"),
                (n["margin-top"] = (i - e * s) / 2 + "px"))
              : ((n.width = i * s + "px"),
                (n[n2const.rtl["margin-left"]] = (e - i * s) / 2 + "px")),
